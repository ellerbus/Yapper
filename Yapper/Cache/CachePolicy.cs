...
namespace Yapper.Cache
{
    ...
    public class CachePolicy
    {
        ...
        static CachePolicy()
        {
            Default = new CachePolicy { SlidingExpiration = TimeSpan.FromMinutes(30) };
        }

        /// <summary>
        /// Gets the default <see cref="CachePolicy"/>.
        /// </summary>
        public static CachePolicy Default { get; set; }
        ...
        public DateTimeOffset AbsoluteExpiration
        {
            ...
            set { _absoluteExpiration = value; Mode = CacheExpirationMode.Absolute; }
        }
        ...
        public TimeSpan SlidingExpiration
        {
            ...
            set { _slidingExpiration = value; Mode = CacheExpirationMode.Sliding; }
        }
        ...
        public TimeSpan Duration
        {
            ...
            set { _duration = value; Mode = CacheExpirationMode.Duration; }
        }
